...
def get_file_path():
    ...
    # Añade un StreamHandler para mostrar los mensajes de logging en la consola
...
def group_data_by_code(df, code_column, code_prefixes, groups):
    if code_column is None:
        ...
        print(f'Se ha creado la columna de nombres basada en la posición de la columna de códigos.')
        ...
        print('Se han poblado los grupos para el grupo basado en el prefijo del código.')
        logging.info('Se han creado las filas de grupo para el grupo basado en el prefijo del código.')
        print('Se han creado las filas de grupo para el grupo basado en el prefijo del código.')
        logging.info('Se han creado los datos del grupo para el grupo basado en el prefijo del código.')
        print('Se han creado los datos del grupo para el grupo basado en el prefijo del código.')
...
def create_custom_columns(output_df, divisors, new_position, column_definitions):
    ...
    print('Las columnas han sido renombradas a los nombres finales.')
    logging.info('Las columnas que solo tienen un encabezado y no tienen datos han sido eliminadas.')
    print('Las columnas que solo tienen un encabezado y no tienen datos han sido eliminadas.')
    logging.info('Las columnas con la palabra "total" en el nombre han sido eliminadas.')
    print('Las columnas con la palabra "total" en el nombre han sido eliminadas.')
    logging.info('Las columnas han sido ordenadas en base al código completo.')
    print('Las columnas han sido ordenadas en base al código completo.')
    logging.info('Las columnas han sido reorganizadas en el dataframe.')
    print('Las columnas han sido reorganizadas en el dataframe.')
...
def style_and_save_excel(temp_filename, final_filename):
    ...
    print('Se han establecido estilos para bordes, franjas y encabezados')
    ...
    print('Se han aplicado estilos al archivo de Excel.')
